...
void Ball::Update(std::vector<Player*>* others, float delta) {
...
void Ball::Update(std::vector<Wall*>* others, float delta) {
	CollisionPoint(others, delta);
...
void Ball::CollisionPoint(std::vector<Player*>* others, float delta) {
	this->collision[LEFT] = false;
	this->collision[RIGHT] = false;
	this->collision[UP] = false;
	this->collision[DOWN] = false;
...
void Ball::CollisionPoint(std::vector<Wall*>* others, float delta) {
	this->collision[LEFT] = false;
	this->collision[RIGHT] = false;
	this->collision[UP] = false;
	this->collision[DOWN] = false;
